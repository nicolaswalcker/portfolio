export default {
  ...
  head: {
    ...
    link: [
      ...
      {
        href: 'https://api.fontshare.com/css?f[]=clash-display@300,400,500,600&display=swap',
        rel: 'stylesheet',
      },
    ],
  },
  ...
  css: [
    ...
    '~/assets/sass/base/_elements.scss',
  ...
  styleResources: {
    scss: [
      ...
      '~/assets/sass/base/_keyframes.scss',
